...
import { PlusCircle, PlusCircleIcon, Search } from "lucide-react";
...
const Products = () => {
    ...
    if (isError|| !products) {
        return(
            <div className="text-center text-red-500 py-4"></div>
        )
  ...
  return (
    ...
    <div className="mb-6">
        <div className="flex items-center border-2 border-gray-200 rounded">
            ...
            <input className="w-full py-2 px-4 rounded bg-white" placeholder="Search products..."
