        ...
        <div className="flex justify-between items-center gap-5">
          <div className="hidden md:flex justify-between items-center gap-5">
            ...
            <div className="relative">
              ...
              <span className="absolute -top-2 -right-2 inline-flex items-center justify-center px-[6.4px] py-1 text-ss font-semibold leading-none text-red-100 bg-red-400 rounded-full "></span>
            </div>
            <hr className="w-0 h-7 border border-solid border-l border-gray-300 mx-3" />
            <div className="flex items-center gap-3 cursor-pointer">
              <div className="w-9 h-9">image</div>
              <span className="font-semibold"> Adeleye Jesutoni</span>
            </div>
          </div>
          <Link href="/settings">
